...
@include('layouts.sign_up_nav')
  <section class="min-vh-100 mb-8">
    <div id='max' class="page-header align-items-start min-vh-50 pt-5 pb-11 m-3 border-radius-lg" style="background-image: url({{asset('img/curved-images/curved14.jpg')}})">
          ...
          <div class="card z-index-0">
            ...
            <div class="row px-xl-5 px-sm-4 px-3">
              ...
              <div class="col-3 px-1">
                <a class="btn btn-outline-light w-100" href="{{route('login_redirect','github')}}">
            ...
            <div class="card-body">
              <form action="{{route('sign_up_user')}}" method='POST' role="form text-left">
                @csrf
                <div class="mb-3">
                ...
                @enderror
                <div class="mb-3">
                    <input type="password" name="confirmation_password" class="form-control" placeholder="Confirm Password" aria-label="Password" aria-describedby="password-addon">
                </div>
